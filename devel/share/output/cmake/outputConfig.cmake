...
if("TRUE" STREQUAL "TRUE")
  set(output_SOURCE_PREFIX /home/proe/Documents/Brain_ROS/src/output)
  set(output_DEVEL_PREFIX /home/proe/Documents/Brain_ROS/devel)
  set(output_INSTALL_PREFIX "")
  set(output_PREFIX ${output_DEVEL_PREFIX})
else()
  set(output_SOURCE_PREFIX "")
  set(output_DEVEL_PREFIX "")
  set(output_INSTALL_PREFIX /home/proe/Documents/Brain_ROS/install)
...
if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'output' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/proe/Documents/Brain_ROS/src/output/${idir}'.  ${_report}")
    endif()
...
foreach(depend ${depends})
  ...
  _list_append_deduplicate(output_EXPORTED_TARGETS ${${output_dep}_EXPORTED_TARGETS})
endforeach()
